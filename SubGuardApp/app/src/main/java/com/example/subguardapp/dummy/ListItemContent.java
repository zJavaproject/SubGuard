...
public class ListItemContent {
    ...
    static {
        ITEMS.add(new ListItem("netflix", "Netflix", "25.05.2022", "45 minut", "30.45"));
        ITEMS.add(new ListItem("spotifylogo", "Spotify", "26.03.2022", "1 godzina", "19.99"));
        ITEMS.add(new ListItem("amazonlogo", "Amazon Prime", "22.09.2021", "3.5 godziny", "45.00"));
        ITEMS.add(new ListItem("4", "YouTube", "15.06.2022", "30 minut", "9.99"));
        ITEMS.add(new ListItem("hbogologo", "HBO GO", "13.02.2022", "2 godziny", "39.99"));
        ITEMS.add(new ListItem("tidallogo", "Tidal", "10.08.2022", "15 minut", "29.99"));
    }
